"""Unit tests for cks_mcp.agents.fork_resolution_agent.lca_arbiter."""
...
from cks_mcp.agents.fork_resolution_agent.lca_arbiter import (
    _branch_is_valid,
...
class TestFindLCA:
    ...
    async def test_common_ancestor_found_at_depth_1(self):
        ...
        with patch(
            "cks_mcp.agents.fork_resolution_agent.lca_arbiter.query_subgraph_tool", side_effect=_fake_query
        ):
...
class TestBranchIsValid:
    async def test_valid_delta(self):
        ...
        with patch(
            "cks_mcp.agents.fork_resolution_agent.lca_arbiter.validate_knowledge",
...
class TestResolveWithLCA:
    async def test_no_lca_found_returns_unresolved(self):
        ...
        with patch(
            "cks_mcp.agents.fork_resolution_agent.lca_arbiter.find_lca",
    ...
    async def test_non_overlapping_returns_resolved_without_winner(self):
        ...
        with (
            ...
            patch(
                "cks_mcp.agents.fork_resolution_agent.lca_arbiter.extract_delta",
    ...
    async def test_erroneous_branch_selects_valid_winner(self):
        ...
        with (
            ...
            patch(
                "cks_mcp.agents.fork_resolution_agent.lca_arbiter._branch_is_valid",
