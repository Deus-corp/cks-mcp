...
def _reload_auth_module():
    ...
    the new value.
    """
    import cks_mcp.http_auth as http_auth_module

    importlib.reload(http_auth_module)

    import cks_mcp.http_events as http_events_module
...
def _reset_auth_module_after_test():
    ...
    ``cks_mcp.http_auth`` expecting the real environment. Reload once
