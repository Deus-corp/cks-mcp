...
CHECK_COMPONENT_VERSIONS_SCHEMA = {
    ...
    "description": (
        ...
        "field in its structure), fetches that repository's version "
        "file from the GitHub raw API -- _version.py by default, or "
        "package.json when the Component's structure sets "
        "'version_source': 'package.json' (for JS/TS components) -- "
        "and compares the two version strings. Returns "
