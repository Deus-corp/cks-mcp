...
Same architecture as ``cks_mcp.agents.critic_agent.critic_agent`` (see that module's
...
``cks_mcp.agents.agent_loop``. Reuses the *exact same* four MCP tools Critic
...
async def _process_one(
    ...
    ``cks_mcp.agents.critic_agent.critic_agent._process_one``, this mirrors it exactly."""
...
async def run_enrichment_agent(
    *,
    ...
    """See ``cks_mcp.agents.critic_agent.critic_agent.run_critic_agent`` -- identical shape,
