...
# Resolution/run_resolver_with_heartbeat now live in cks_mcp.agents.agent_loop
# (shared with cks_mcp.agents.enrichment_agent.enrichment_agent) -- re-exported under their
# original names here for backward compatibility (this module's own
# tests, and any external code, import them from cks_mcp.agents.critic_agent.critic_agent).
...
class CriticAgentSettings:
    ...
    def from_env(cls) -> CriticAgentSettings:
        ...
        # resolve_crdt_fork and cks_mcp.agents.fork_resolution_agent.fork_resolution_agent's
...
async def run_critic_agent(
    *,
    ...
    (``cks_mcp.agents.embedded_agents``, ADR-012 -- the server owns process
