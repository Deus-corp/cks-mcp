...
winner-selection policy in ``cks_mcp.agents.fork_resolution_agent.fork_resolution_agent``.
...
class LCAResolution:
    ...
    ``resolved`` mirrors ``cks_mcp.agents.agent_loop.Resolution.resolved`` so
